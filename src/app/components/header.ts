    ...
    <nav aria-label="Global" class="flex items-center justify-between p-6 lg:px-8">
      ...
      <div class="hidden lg:flex lg:flex-1 lg:justify-end">
        ...
        <div class="relative inline-block w-11 h-5">
          <input [checked]="isCheked()" id="switch-component" (click)="themeService.toggle()" type="checkbox" class="peer appearance-none w-11 h-5 bg-slate-100 rounded-full checked:bg-slate-800 cursor-pointer transition-colors duration-300" />
